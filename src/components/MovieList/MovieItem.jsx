...
const MovieItem = ({ props }) => {
  ...
  return (
    <div className="px-1 my-1 lg:px-4 w-full md:w-1/3 lg:w-1/4">
      <div
        key={props.id}
        className="relative bg-white w-full h-96 mb-8 shadow-lg rounded-2xl overflow-hidden border border-gray-300 flex flex-col space-y-2"
      >
